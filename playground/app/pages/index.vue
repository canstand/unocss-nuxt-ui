    ...
    <UHeader>
      <template #title>
        <svg width="1020" height="200" viewBox="0 0 1020 200" fill="none" xmlns="http://www.w3.org/2000/svg"
          ...
          <img src="https://unocss.dev/logo.svg" alt="UnoCSS Logo" class="inline-block ms-4 h-6" />
      ...
      <UContainer>
        ...
        <div class="flex flex-col items-center">
          <div class="mt-6xl flex gap-lg items-center justify-center">
            <UButton variant="soft" color="neutral" aria-label="Toggle dark mode"
              :icon="isDark ? 'i-lucide-sun' : 'i-lucide-moon'" @click="handleToggleDarkMode" />

            <UButton variant="soft" color="neutral" icon="i-lucide-github" as="a"
          ...
          <div class="mt-6xl flex flex-wrap gap-lg max-w-200 items-center justify-center">
            <USelect v-for="variant in selectVariants" :key="variant" :items="items" :placeholder="variant"
