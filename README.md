...
- Name: UnoCSS for Nuxt UI
- Package name: unocss-nuxt-ui
...
- [✨ &nbsp;Release Notes](/CHANGELOG.md)
  <!-- - [🏀 Online playground](https://stackblitz.com/github/canstand/unocss-nuxt-ui?file=playground%2Fapp.vue) -->
...
That's it! You can now use UnoCSS for Nuxt UI in your Nuxt app ✨
